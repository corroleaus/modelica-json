...
mo.describe('util', function () {
  ...
  // The same partial-qualification rule as resolveEnumerationType above, but
  // for component types rather than enumerations.
  mo.describe('testing resolveTypeSpecifier()', function () {
    ...
    const sourceFile = ut.getMoFiles('Buildings.Controls.OBC.ASHRAE.G36.Generic.TrimAndRespond.mo')
